...
def assessments_home():
    assessment.destroy()
    call(["python", "main_experiment_2.py"])


def assessments_sign_in():
    call(["python", "sign_up_2.py"])


def assessments_about_us():
    assessment.destroy()
    call(["python", "about_us_2.py"])
...
back_to_top = Button(assessment, image=button_image, bg="green", relief="raised", borderwidth=0)
back_to_top.grid(column=4, row=1)
...
open_assessment_file = open("assessment_2.txt")
...
first_assessment.grid(column=0, row=1, pady=5)

# ------------------ Display time ------------------
open_time_file = open("time_2.txt")
...
first_time.grid(column=1, row=1, pady=5)

# ------------------ Display time left ------------------
datetime.datetime.now()
time_file_display = open("time_2.txt")
time_label = Label(assessment, bg="#88b589", font=("Times New Roman", 20))
